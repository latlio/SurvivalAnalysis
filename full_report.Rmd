---
title: "A Bootstrap Validated Parsimonious Cox PH Regression Model Predicting AIDS Survival"
...
Our analysis illuminates the importance of lower CD4 count and the IDV treatment as predictors associated with lower risk of AIDS diagnosis or death. 
...
```
Figure 10. The Effects of Each Predictor on Log Survival Time
...
\begin{enumerate}
  \item The sum of what each player receives should be equal to the total reward.
  \item If two people contributed the same amount, they should receive equal proportions of the reward. 
  \item If any player did not contribute any value, they should receive no part of the reward.
  \item If multiple games are played, then an individual's total reward across all games should be equal to the sum of their earnings from each game. 
\end{enumerate}
...
## Analysis
See the XGBoost jupyter notebook for the analysis (I was really struggling in getting Python to work in RStudio, so putting my code in this markdown feels like more trouble than it is worth right now!).
...
\item https://www.analyticsvidhya.com/blog/2016/03/complete-guide-parameter-tuning-xgboost-with-codes-python/
\item https://stackoverflow.com/questions/53562813/xgboost-cox-survival-time-entry
\item https://www.analyticsvidhya.com/blog/2016/02/complete-guide-parameter-tuning-gradient-boosting-gbm-python/
\item https://arxiv.org/pdf/1802.03888.pdf
\item http://www.saedsayad.com/docs/gbm2.pdf
\item https://arxiv.org/pdf/1701.07926.pdf
\item https://www.hindawi.com/journals/cmmm/2013/873595/
\item https://medium.com/@gabrieltseng/interpreting-complex-models-with-shap-values-1c187db6ec83
\item http://papers.nips.cc/paper/7062-a-unified-approach-to-interpreting-model-predictions.pdf
\end{itemize}
