...
ggsurvplot(surv, data = data, 
           ...
           risk.table.y.text = F) + 
  ggtitle("Figure 4. Survival Curve of Time to Event Variable") +
  theme(plot.title = element_text(size = 10))
```
...
ggsurvplot(surv2, data = data, 
           ...
           risk.table.y.text.col = T, 
           risk.table.y.text = F) +
  ggtitle("Figure 5. Survival Curves Comparing Control to Treatment of Time to Event Variable ") +
  theme(plot.title = element_text(size = 10))
```
